...
## Acceptanskriterier
Som användare vill jag kunna boka datum och tid samt ange antal spelare så att jag kan reservera 1 eller flera baner i bowlinghallen.
-Inputfält för respektive parameter där användaren kan ange sina önskemål om tid, datum, spelare och banor
-Om inte alla inputfält är ifyllda visas ett felmeddelande där användaren uppmanas att fylla i alla fält.
-Om antalet spelare överstiger maxantalet tillåtet för ett visst antal banor så visas ett felmeddelande

Som användare vill jag kunna välja skostorlek för varje spelare så varje spelare får skor som passar.
-Sektion där användaren kan lägg till och ange skostorlek för respektive spelare
-Om antalalet spelare och skor skiljer sig åt, går en bokning ej att genomföras och ett felmeddelande visas där användaren uppmanas fylla i korrekt.
...
-En knapp förknippad med respektive inputfält för skobokning som man kan klicka på för att ta bort ett par skor
...
-En knapp som samlar all data från inputfälten, spara dessa i ett object och POST till APIn
-Efter bokningen ska visas en bekräftelsesida där datum, tid, antal spelare, banor samt bokningsnummer och pris syns

Som användare vill jag kunna navigera tillbaka till bokningsvyn efter bekräftelse.
-En knapp som leder användaren tillbaka till bokningssidan
# Individuell examination: Strajk bowling
